...
namespace Bingotao.Customer.GIS.LicenseInitializer
{
    /// <summary>
    ...
    public class LicenseInitializer
    {
        ...
        {
            return this.InitializeApplication(new esriLicenseProductCode[] { esriLicenseProductCode.esriLicenseProductCodeEngine, esriLicenseProductCode.esriLicenseProductCodeEngineGeoDB },
